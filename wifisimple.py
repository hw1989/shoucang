...
#'a','e','beng','fo','mie','ga','nai','miu','ao','po','bo','yo','ou',
pinyin=[ 'ai', 'an', 'ang',
             'ba', 'bai', 'ban', 'bang', 'bao', 'bei', 'ben', 
            'bi', 'bian', 'biao', 'bie', 'bin', 'bing',  'bu', 'ca',
            ...
            'ding', 'diu', 'dong', 'dou', 'du', 'duan', 'dui', 'dun', 'duo',
             'en', 'er', 'fa', 'fan', 'fang', 'fei', 'fen', 'feng', 
            'fou', 'fu',  'gai', 'gan', 'gang', 'gao', 'ge', 'gei', 'gen',
...
net=['sb','2b','abc','123','12345','123456','qwert']
english=['and','fuck','love','who','no','u','you','your','hello','hi','dream','kiss','is','i']
number=['00','000','0000','00000','000000','01','03','04','05','06','07','08','09','10','11','12','1314','120','110','119',
        '111','1111','11111','111111','250','251','210','222','2222','555','666','666666','88','888888','88888888','999','99','9999']
date=['1987','1988','1989','1990','1991','1992','1993','1994','2016']
print(len(pinyin)+len(net)+len(english)+len(number)+len(date))